...
Revision ID: 56a5263e51a4
Revises:
Create Date: 2022-10-03 15:15:27.314532
...
def upgrade():
    # ### commands auto generated by Alembic - please adjust! ###ewr
    ...
    sa.Column('food_items', sa.PickleType(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('food_items', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['food_items'], ['food_items.id'], ),
