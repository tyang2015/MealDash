      ...
      {errors.length>0 && hasSubmitted && (
        <div className="validation-errors-container order-confirmation-errors">
            <ul className='validation-errors'>
                ...
                <li style={{listStyle: "none"}} key={idx}>{error}</li>
                ))}
            </ul>
        </div>
      )}
      <div className='right-pane-top-one-fifth-container'>
        ...
        <div className='order-summary-container'>
          ...
          <div className='order-summary-title-container'>
            Order Summary
            {!toggleOrderSummary? (<svg style={{cursor: "pointer"}} onClick={()=> setToggleOrderSummary(true) } width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="styles__StyledInlineSvg-sc-12l8vvi-0 jFpckg"><path fill-rule="evenodd" clip-rule="evenodd" d="M8.79289 18.7071C8.40237 18.3166 8.40237 17.6834 8.79289 17.2929L14.0858 12L8.79289 6.70711C8.40237 6.31658 8.40237 5.68342 8.79289 5.29289C9.18342 4.90237 9.81658 4.90237 10.2071 5.29289L16.2071 11.2929C16.3946 11.4804 16.5 11.7348 16.5 12C16.5 12.2652 16.3946 12.5196 16.2071 12.7071L10.2071 18.7071C9.81658 19.0976 9.18342 19.0976 8.79289 18.7071Z" fill="#494949"></path></svg>) :
            (<svg style={{cursor: "pointer"}} onClick={()=> setToggleOrderSummary(false)} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="styles__StyledInlineSvg-sc-12l8vvi-0 jFpckg"><path fill-rule="evenodd" clip-rule="evenodd" d="M5.29289 8.79289C5.68342 8.40237 6.31658 8.40237 6.70711 8.79289L12 14.0858L17.2929 8.79289C17.6834 8.40237 18.3166 8.40237 18.7071 8.79289C19.0976 9.18342 19.0976 9.81658 18.7071 10.2071L12.7071 16.2071C12.5196 16.3946 12.2652 16.5 12 16.5C11.7348 16.5 11.4804 16.3946 11.2929 16.2071L5.29289 10.2071C4.90237 9.81658 4.90237 9.18342 5.29289 8.79289Z" fill="#494949"></path></svg>)}
          </div>
        </div>
        {toggleOrderSummary && (<OrderSummaryContainer cartItems={cartItems}/>)}
      </div>
