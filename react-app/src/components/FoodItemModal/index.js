...
const FoodItemModal = ({ restaurant, setForceCartUpdate, forceCartUpdate,setSubmittedCartItems, submittedCartItems,setSubmittedCart, setFoodItemModal, foodItem}) => {
  ...
  useEffect(()=> {
    ...
    if (preferences.length>100) errs.push("Preferences must be less than 100 characters")
    setErrors(errs)
      ...
      <div className='food-item-main-container'>
        ...
        <div>
          {errors.length>0 && hasSubmitted && (
            <div className="validation-errors-container order-confirmation-errors food-item-modal">
        ...
        <div className='food-item-main-content-container'>
          <h1 className='food-item-name-text'>{foodItem?.name}</h1>
